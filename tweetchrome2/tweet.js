...
function get_prop_value_html(property,valstring)
{
    var propertydom = '<span class="prop">'+property+':</span>';
    var valuedom ='<span class="val">&nbsp;'+valstring+   '</span>';
    return   propertydom+valuedom;
}
function set_to_dom(element,htmlstring)
{
    $(element).html(htmlstring);
	return;
}
function set_prop_val_to_dom(element,property,valstring)
{
		set_to_dom(element,get_prop_value_html(property,valstring));
}
var tweeps = {
    "tweets":null,
    "getWhenIJoinedTwitter": function (user, element) {
        var propertyname = 'Joined twitter On';
        set_prop_val_to_dom(element,propertyname,"Loading...");
        ...
        $.getJSON(url, function (data) {
            if (data.created_at) {
				...
				set_prop_val_to_dom(element,propertyname,myDateStr);
				...
				set_prop_val_to_dom(element,propertyname,"Error!! Not Found");
            }
        });
    },
    "getTweepsInfo": function (user, element) {
        var propertyname = 'Info';
            ...
            if (data.query.results.strong) {
                ...
                $.getJSON(url2, function (data2) {
                    if (data2.query.results.a) {
						...
						set_prop_val_to_dom(element,propertyname,text);
    ...
    "gettwitterholicGR": function (user, element) {
        ...
        $.getJSON(url, function (data) {
            if (data.query.results.strong) {
				...
				set_prop_val_to_dom(element,propertyname,rank);
    ...
    "gettwitpic": function (user, element) {
        ...
        $.getJSON(url, function (data) {
            if (data.query.results.img) {
				...
				set_prop_val_to_dom(element,propertyname,imghtml);
    ...
    "getfacebook": function (user, element) {
        var propertyname = 'On Facebook(Possible)';
        /*$(element).html(propertyname + "Loading..." + "</span>");*/
         $(element).html('');
    ...
    "gettwitterholicLR": function (user, element) {
        var propertyname = 'Location Rank';
       /* $(element).html(propertyname + "Loading..." + "</span>");*/
       $(element).html('');
    ...
    "gettweeteffect": function (user, element,tselement) {
        ...
        $.getJSON(url, function (o) {
            ...
            if (o[0].user.screen_name) {
				...
				set_prop_val_to_dom(element,propertyname,myeffect);
